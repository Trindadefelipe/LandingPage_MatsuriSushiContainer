...
export default function About() {
    return (
        <section id="sobre" className="content-section relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-amber-500/50 to-transparent" />

            <div className="py-16 md:py-24 bg-gradient-to-b from-amber-50 via-white to-amber-50 relative">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                        ...
                        >
                            <div className="relative max-w-md mx-auto lg:max-w-none">
                                <div className="hidden sm:block absolute -inset-4 border-2 border-amber-500/30 rounded-lg" />
                                <div className="hidden sm:block absolute -inset-8 border border-amber-500/10 rounded-lg" />

                                <div className="bg-black p-5 sm:p-8 rounded-lg shadow-2xl relative">
                                    <img
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-1/2"
                        >
                            <span className="text-amber-600 tracking-[0.18em] sm:tracking-[0.3em] uppercase text-xs sm:text-sm font-medium">
                                Nossa História
                            </span>
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-black mt-4 mb-6">
